...
fileprivate let logger: Logger = Logger(subsystem: "org.appfair.app.ShowcaseFuse", category: "ShowcaseFuse")
...
public struct ShowcaseFuseRootView : View {
    @ObservedObject var appDelegate = ShowcaseFuseAppDelegate.shared
...
public class ShowcaseFuseAppDelegate: ObservableObject {
