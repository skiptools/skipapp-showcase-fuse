...
struct DocumentPickerPlayground: View {
    ...
    var body: some View {
        VStack(alignment: .center) {
            ...
            .withDocumentPicker(isPresented: $presentPreview, allowedContentTypes: [UTType.image, UTType.pdf], selectedDocumentURL: $selectedDocument, selectedFilename: $filename, selectedFileMimeType: $mimeType)
